...
== Hinweise zu Branches

IMPORTANT: *Im Branch `master` sowie im `Integrationsbranch` befindet sich eine stabile Version – jedoch ohne Datenbankanbindung. Eine Version mit Datenbankanbindung befindet sich im Branch `datenbank-anbindung`, diese enthält jedoch noch vereinzelte Bugs.*
