...
IMPORTANT: *Im Branch `master` befindet sich eine stabile Version – jedoch ohne Datenbankanbindung. Eine Version mit Datenbankanbindung befindet sich im `Integrationsbranch`, diese enthält jedoch noch vereinzelte Bugs.*
