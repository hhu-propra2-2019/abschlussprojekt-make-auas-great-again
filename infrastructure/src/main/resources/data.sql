...
values (1, "student1"),(2, "studentin2"),(3, "studentin3"),(4, "studentin");
...
values(1, 1, "Vieles war gut"),(2, 1, "Manches"),(3, 1, "Gar nichts"),
(4, 2, "Garnichts"), (5,2, "Es hat mir alles gefallen"),
(6, 3, "Weiß nicht"), (7, 3, "Warum nicht?");

insert into antwort(id, frage)
values(8, 4),(9,4),(10,4);

insert into auswahl(id, auswahltext, frage, antwort)
values(1, "Sehr gut", 4, 8),(2, "OK", 4, 9), (3, "Garnicht", 4, 10);
