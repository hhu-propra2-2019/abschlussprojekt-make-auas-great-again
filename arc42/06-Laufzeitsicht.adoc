...
Das Persistieren der Antwoten ist anonym. Das heißt, es wird nicht gespeichert, wer welche Antworten abgegeben hat.

=== Evaluationsergebnisse sehen

* Nur mit erfolgeicher Anmeldung können Studierende sich Ergebnisse anschauen, die von den Dozenten veröffentlicht worden sind.
